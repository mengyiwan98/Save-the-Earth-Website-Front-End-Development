    ...
    return (
        ...
        <div className="pri">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Save the Earth.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Save the Earth, accessible from <a href="http://localhost:3001/" rel="external nofollow noopener" target="_blank">http://localhost:3001/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: wan.mengyi98@gmail.com</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="http://localhost:3001/#Contact" rel="external nofollow noopener" target="_blank">http://localhost:3001/#Contact</a></p>
                </li>
            </ul>
        </div>
        </body>
